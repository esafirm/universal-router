 ...
 *
 * Instances of [DeepLinkUri] are well-formed and always have a scheme, host, and path. With
 ...
 *
 * This class has a modern API. It avoids punitive checked exceptions: [toDeepLinkUri] throws
 * [IllegalArgumentException] on invalid input or [toDeep] returns null if the input is an
